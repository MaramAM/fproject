...
public class taskOrganiz extends AppCompatActivity {
    ImageButton button;
    TextView t1, t2;
    Menu menu;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_task_organiz);
    ...
    public void videoplay(View view) {
        String vidiop = "android.resource://com.example.nourah.myapplication/" + R.raw.orgnaizer;
